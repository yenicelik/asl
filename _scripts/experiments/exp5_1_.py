...
class Exp5_1:
    """
        ...
        We have experiments:
            - Get only SHARDED
            - Get only NON-SHARDED
    """

    def __init__(self):
        print("(Non-)Sharded Multi-Get with Middleware 2!")
    ...
    def set_configuration(self):
        ...
        self.worker_threads_per_middleware = 64  # 64 has highest throughput
...
class ExperimentBaseline1(BaseExperimentRunner, Exp5_1):
    ...
    def __init__(self):
        ...
        preliminary_name = "ExperimentShardedNonShardedGet1/"
    ...
    def run(self):
        ...
        for sharding in self.sharding:
            ...
            for multikeyget_size in self.reads:
                ...
                for i in range(self.repetitions):
                    ...
                    for client_number in ['Client1', 'Client2', 'Client3']:
                        def runner_function():
                            logfile = self.remote_logdir + self.name + "_" + "multikeysize_{}_middleware1__rep_{}_client_{}_sharding_{}_middlewarethreads_{}.txt".format(
                                multikeyget_size, i, client_number, sharding, self.worker_threads_per_middleware)
                    ...
                    self.copy_logs_to_local(
                        ...
                        self.local_logdir + "Middleware1_multikeygetsize_{}_rep_{}__sharding_{}__middlewareworkerthreads_{}/".format(
                            multikeyget_size, i, sharding, self.worker_threads_per_middleware)
                    )
                    time.sleep(10)
                    self.copy_logs_to_local(
                        [
