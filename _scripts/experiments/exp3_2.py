...
class Exp3_2:
    ...
    def __init__(self):
        print("Baseline with Middleware 2!")
...
class ExperimentBaselineMW2(BaseExperimentRunner, Exp3_2):

    def __init__(self):
        super(ExperimentBaselineMW2, self).__init__()
        # Run the initalizers from the parent classes
        self.set_configuration()

        preliminary_name = "ExperimentMiddleware2/"
        self.name = "Exp32"
    ...
    def run(self):
        ...
        upload_jar([MIDDLEWARE['Middleware2']], compile=False)
                    ...
                    for i in range(self.repetitions):
                        ...
                        for client_number in ['Client1', 'Client2', 'Client3']:
                            ...
                            def runner_function():
                                ...
                                logfile = self.remote_logdir + self.name + "_virtualclients_{}_middlewareworkerthreads_{}__rep_{}_client_{}_writes_{}.txt".format(virtual_client_threads, middleware_workerthread, i, client_number, self.writes)
                                ...
                                self.run_memtiered_servers(
                                    ...
                                    logfile=logfile + "_" + self.name + "_MW1.txt",
                                    time=self.time,
                                ...
                                self.run_memtiered_servers(
                                    ...
                                    port=self.middleware_port,
                                    logfile=logfile + "_" + self.name + "_MW2.txt",
                                    time=self.time,
                                    write_ratio=self.writes,
                                    read_ratio=self.reads,
                                    virtual_clients_per_thread=virtual_client_threads,
                        ...
                        self.copy_logs_to_local(
                            ...
                            self.remote_logdir,
                            self.local_logdir + "Middleware2_threads_{}_vc_{}_rep_{}__writes_{}/".format(middleware_workerthread, virtual_client_threads, i, self.writes)
                        )
                        time.sleep(5)
...
if __name__ == "__main__":
    experiment1 = ExperimentBaselineMW2()
    experiment1.run()
